...
/* lists */
export const GET_MOVIE_COLLECTIONS_BY_USER_ID = 'GET_MOVIE_COLLECTIONS_BY_USER_ID'
export const NEW_USER_MOVIE_COLLECTIONS = 'NEW_USER_MOVIE_COLLECTIONS'
export const USER_MOVIE_COLLECTION = 'USER_MOVIE_COLLECTION'
export const COLLECTION_NOT_FOUND = 'COLLECTION_NOT_FOUND'
export const NO_COLLECTIONS_FOUND = 'NO_COLLECTIONS_FOUND'
export const CREATE_MOVIE_COLLECTION = 'CREATE_MOVIE_COLLECTION'
